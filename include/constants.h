...
#define NS_ACC_ERR_MASKEXISTS		"The mask \2%s\2 already is in your access list."
#define NS_ACC_ERR_MASKEXISTS2		"The mask \2%s\2 already is in the access list of \2%s\2."
#define NS_ACC_ERR_MASKFORMAT		"Mask must be in format <user@host>"
#define NS_ACC_ERR_MASKFORMAT2		"Please use a more secure mask. \2%s\2 matches all users"
#define NS_ACC_ERR_MASKNOTFOUND		"The mask \2%s\2 was not found in your access list"
#define NS_ACC_ERR_MASKNOTFOUND2	"The mask \2%s\2 was not found in the access list of \2%s\2"
#define NS_ACC_ERR_USAGE			"Usage: \2ACCESS\2 <command> [arguments]"
#define NS_ACC_RPL_1ENTRYREMOVED	"1 entry removed."
#define NS_ACC_RPL_ADDSUCCESS		"The mask \2%s\2 has been added to your access list."
#define NS_ACC_RPL_ADDSUCCESS2		"The mask \2%s\2 has been added to the access list of \2%s\2."
#define NS_ACC_RPL_DELSUCCESS		"The mask \2%s\2 has been deleted from your access list."
#define NS_ACC_RPL_DELSUCCESS2		"The mask \2%s\2 has been deleted from the access list of \2%s\2."
#define NS_ACC_RPL_LEVEL0			"%s - 0 - No Access."
#define NS_ACC_RPL_LEVEL1			"%s - 1 - Matches an entry in the nickname's access list."
#define NS_ACC_RPL_LEVEL2			"%s - 2 - User has identified for this nickname."  
#define NS_ACC_RPL_LIST				"The nickname \2%s\2 has the following access entries:"
#define NS_ACC_RPL_LISTFOUND1		"Listing Complete - \2%i\2 entry found"
#define NS_ACC_RPL_LISTFOUND2		"Listing Complete - \2%i\2 entries found"
#define NS_ACC_RPL_NENTRIESREMOVED	"%i entries removed."
#define NS_ACC_RPL_NOENTRIES		"You don't have any access list entries."
#define NS_ACC_RPL_NOENTRIES2		"The nickname \2%s\2 doesn't have any access list entries."
#define NS_ACC_RPL_LISTENTRIES		"\2%i\2 - \2%s\2"
#define NS_ACC_RPL_WIPESUCCESS		"Your access list has been wiped."
#define NS_ACC_RPL_WIPESUCCESS2		"The access list of \2%s\2 has been wiped."
