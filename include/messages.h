...
#define NS_RPL_ATH_ACCEPTED			"You have accepted the authorization request from \2%s\2."
...
#define NS_RPL_ATH_DECLINED			"You have declined the authorization request from \2%s\2."
...
#define NS_ERR_ATH_LISTCOMPLETE1	"Listing complete - \21\2 match found"
...
#define NS_RPL_ATH_TEXT1			"\2%s\2 wants to add you to his/her notify list."
#define NS_RPL_ATH_TEXT2			"\2%s\2 wants to add you to the \2UOP\2 list of %s"
#define NS_RPL_ATH_TEXT3			"\2%s\2 wants to add you to the \2VOP\2 list of %s"
#define NS_RPL_ATH_TEXT4			"\2%s\2 wants to add you to the \2HOP\2 list of %s"
#define NS_RPL_ATH_TEXT5			"\2%s\2 wants to add you to the \2AOP\2 list of %s"
#define NS_RPL_ATH_TEXT6			"\2%s\2 wants to add you to the \2SOP\2 list of %s"
...
#define NS_RPL_NFY_WIPESUCCESS2		"The notify list of \2%s\2 has been wiped."
...
#define CS_ERR_ACCCMD_USAGE			"Usage: \2%s\2 [#channel] \2[nickname]\2"
